...
export const LAW_FIRM_ADOPTION_OBSERVATIONS: AdoptionObservation[] = [
  {
    ...
    comparison: {
      businessFunctionId: null, taskId: null, utilizationDepth: null,
      evidenceRelation: "proxy",
      geography: { level: "region", label: "United States and nine European countries" },
      evidenceConfidence: wkConfidence,
      estimateBasis: "observed", measure: "tool_use_frequency", normalizedScaleId: null,
      mappingRationale: "Weekly generative-AI use is not attributed to a business function, task, or utilization depth in the source.",
    },
  ...
  },
  {
    ...
    comparison: {
      ...
      evidenceConfidence: wkConfidence,
      estimateBasis: "observed", measure: "tool_use_frequency", normalizedScaleId: null,
      mappingRationale: "Daily generative-AI use is not attributed to a business function, task, or utilization depth in the source.",
    },
    extractionNotes: "Extracted from the report's law-firm versus corporate legal department comparison.",
    extractedBy: "Codex research pass",
    createdAt: CREATED_AT,
  },
  {
    ...
    comparison: {
      businessFunctionId: null, taskId: null, utilizationDepth: null,
      evidenceRelation: "proxy",
      geography: { level: "other", label: "Legal Trends respondent geography not separately published" },
      evidenceConfidence: clioConfidence,
      estimateBasis: "observed", measure: "broad_adoption_prevalence", normalizedScaleId: null,
      mappingRationale: "Firm-level use of any AI does not identify which business functions, tasks, or depth levels are utilized.",
    },
  ...
  },
  {
    ...
    comparison: {
      ...
      evidenceConfidence: clioConfidence,
      estimateBasis: "observed", measure: "broad_adoption_prevalence", normalizedScaleId: null,
      mappingRationale: "Use of a legal-specific AI product spans several possible tasks and does not report task coverage or utilization depth.",
    },
